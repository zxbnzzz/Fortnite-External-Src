...
#define IOCTL_MEMORY_READ CTL_CODE(FILE_DEVICE_UNKNOWN, 0x2345, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IOCTL_MEMORY_BASE CTL_CODE(FILE_DEVICE_UNKNOWN, 0x3456, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IOCTL_MEMORY_GUARDED_REGION CTL_CODE(FILE_DEVICE_UNKNOWN, 0x4567, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IOCTL_MEMORY_GET_DIR_BASE CTL_CODE(FILE_DEVICE_UNKNOWN, 0x5678, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define IOCTL_MEMORY_SECURITY 0x9af2b37
...
namespace mem {
	...
	bool find_driver() {
		driver_handle = CreateFileW(L"\\\\.\\765bbr33-gh4d-32e9-a734-340034758fff",
	...
	void read_physical(PVOID address, PVOID buffer, DWORD size) {
		...
		arguments.security = IOCTL_MEMORY_SECURITY;
		...
		DeviceIoControl(driver_handle, IOCTL_MEMORY_READ, &arguments, sizeof(arguments), nullptr, NULL, NULL, NULL);
	}
	...
	uintptr_t fetch_cr3() {
		...
		DeviceIoControl(driver_handle, IOCTL_MEMORY_GET_DIR_BASE, &arguments, sizeof(arguments), nullptr, NULL, NULL, NULL);
	...
	uintptr_t find_image() {
		...
		DeviceIoControl(driver_handle, IOCTL_MEMORY_BASE, &arguments, sizeof(arguments), nullptr, NULL, NULL, NULL);
