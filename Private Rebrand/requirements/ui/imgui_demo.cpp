    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ...
                draw_list->AddRect(ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), IM_COL32(255, 165, 0, 255));

        
                draw_list->AddRectFilled(marker_min, marker_max, IM_COL32(255, 165, 0, 255));
